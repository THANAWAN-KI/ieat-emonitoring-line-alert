(function(){
  ...
  async function exportPng(){
    ...
    try{
      ...
      const name=`ieat-disaster-map-report-${period}-${new Date().toISOString().slice(0,10)}.png`;
