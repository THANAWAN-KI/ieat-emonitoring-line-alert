...
def weather_icon(title: str) -> str:
    if any(word in title for word in ("น้ำท่วม", "น้ำป่า", "ฝนตกหนัก", "มรสุม")):
        return ASSET_URLS["flood"]
    if any(word in title for word in ("อากาศร้อน", "คลื่นความร้อน", "ภัยแล้ง")):
        return ASSET_URLS["nature"]
    if any(word in title for word in ("หมอกควัน", "ฝุ่น", "PM2.5")):
        return ASSET_URLS["air"]
    return ASSET_URLS["world"]


def weather_info_row(icon_url: str, label: str, value: str) -> dict:
    return {
        ...
        "contents": {
            ...
            "body": {"type": "box", "layout": "vertical", "paddingAll": "14px",
                ...
                {"type": "box", "layout": "horizontal", "alignItems": "center",
                 "spacing": "sm", "contents": [
                    icon_image(
                        ASSET_URLS["danger"] if level.startswith("อันตราย")
                ...
                {"type": "box", "layout": "horizontal", "alignItems": "center",
                 "spacing": "sm", "margin": "lg", "contents": [
                    icon_image(weather_icon(title), "26px"),
                    {"type": "text", "text": "ประเภทภัย", "size": "md",
                     "weight": "bold", "color": "#FF4B0A", "flex": 1},
                ]},
                {"type": "text", "text": hazards, "size": "2xl",
                 "weight": "bold", "color": "#FF4B0A", "wrap": True,
                 "margin": "sm"},
                weather_info_row(
                    ASSET_URLS["alert"], "ประกาศกรมอุตุนิยมวิทยา", title
                ),
                weather_info_row(
                    ASSET_URLS["world"], "เวลาที่ระบบตรวจพบ", now
                ),
                ...
                {"type": "box", "layout": "vertical", "margin": "lg",
                 ...
                 "cornerRadius": "14px", "contents": [
                    {"type": "box", "layout": "horizontal", "alignItems": "center",
                     "spacing": "sm", "contents": [
                        icon_image(ASSET_URLS["factory"], "24px"),
